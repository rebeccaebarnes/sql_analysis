...
class SQLTest:
    ...
    def save_results(self, index: bool = False, replace: bool = True) -> NoReturn:
        """
    ...
    def run_test(self, test_string: Optional[str] = None,
                 ...
                 save_replace: bool = True) -> NoReturn:
        """
        ...
        if self.save_location:
            self.save_results(replace=save_replace)
...
def compare_tables(table_names: Sequence[str], table_alias: Sequence[str],
    ...
    tester.run_test(review_threshold=review_threshold, save_replace=save_replace)
